            ...
            <div class="flex px-6 pb-4 border-b">
                ...
                <div class="ml-auto">
                    <a href="/admin/blogs/create"
                        class="py-2 px-3 text-xs text-white font-semibold bg-indigo-500 rounded-md">新規投稿
                    </a>
                </div>
            </div>
