            ...
            <div class="mt-8">
                ...
                <form action="{{ route('contact') }}" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="name_kana"
                            class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border"
                            type="text" placeholder="例）タナカタロウ" name="name_kana" value="{{ old('name') }}">
                        @error("name_kana")
                            <p class="text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-4">
                        <label for="phone" class="block text-left p-1 my-1 font-medium" name="name_number">電話番号</label>
                        <input id="phone"
                            class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="body"
                            ...
                            placeholder="ご自由にご記入ください" name="body">
                            {{ old('body') }}
                        </textarea>
                    </div>
